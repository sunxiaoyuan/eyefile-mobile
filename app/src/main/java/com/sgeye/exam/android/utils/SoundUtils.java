package com.sgeye.exam.android.utils;
...
public class SoundUtils {
    ...
    public static void playSound(int rawId) {
        ...
        soundPool.load(Margaret.getApplicationContext(), rawId, 1);
...
//        soundPool.play(1, 1, 1, 0, 0, 1);
    ...
    public static void playSound(){
        ...
        mediaPlayer01 = MediaPlayer.create(Margaret.getApplicationContext(), R.raw.custome_notification);
        mediaPlayer01.start();
    }
}
