...
public abstract class BaseBottomDelegate extends MargaretDelegate implements View.OnClickListener {
	...
	// 正常下颜色
	private int mUnClickedColor = Color.RED;
	...
	public void onBindView(@Nullable Bundle savedInstanceState, @NonNull View rootView) {
		...
		for (int i = 0; i < size; i++) {
			...
			// 初始化数据
			itemIcon.setImageResource(bean.getIMAGE_ID());
			itemTitle.setText(bean.getTitle());
			if (i == mIndexDelegate) {
				itemIcon.setImageResource(bean.getCLICKED_IMAGE_ID());
